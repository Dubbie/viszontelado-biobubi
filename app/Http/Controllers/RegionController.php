...
use App\Http\Requests\UpdateBiobubiDeliveryRequest;
use App\Region;
use App\RegionZip;
...
class RegionController extends Controller
{
	...
	public function biobubiDeliveries()
	{
		return view('region.biobubi-deliveries')->with([
			'regions' => Region::all(),
		]);
	}

	public function updateBiobubiDelivery(UpdateBiobubiDeliveryRequest $request)
	{
		...
		if ($region->setBiobubiDelivery($checked)) {
		...
		return response()->json([
			'success' => false,
			'message' => 'Hiba történt a BioBubi futár frissítésekor.'
		]);
	}
}
