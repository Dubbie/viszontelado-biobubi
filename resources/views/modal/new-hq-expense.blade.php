<!-- Modal -->
<div class="modal fade" id="newHqExpense" tabindex="-1" role="dialog" aria-labelledby="newHqExpenseLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ action('RevenueController@storeExpense') }}" method="POST">
                @csrf
                <input type="hidden" name="e-hq" value="true">
                <div class="modal-header">
                    <h5 class="modal-title" id="newHqExpenseLabel">Új központi kiadás</h5>
