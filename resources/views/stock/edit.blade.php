        ...
        <div class="card card-body">
            <div class="alert alert-danger">
                <div class="d-flex align-items-center">
                    <svg width="24px" height="24px" viewBox="0 0 16 16" class="bi bi-exclamation-square mr-3 text-danger-pastel" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"></path>
                        <path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z"></path>
                    </svg>
                    <div class="text">
                        <p class="lead mb-0">Az itt módosított készletről a rendszer <b>nem fog létrehozni kiadást és bevételt</b>.</p>
                    </div>
                </div>
            </div>
