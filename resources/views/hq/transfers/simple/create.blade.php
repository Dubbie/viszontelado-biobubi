                ...
                <div class="card card-body text-center">
                    ...
                    <div class="row">
                        <div class="col-md-10 offset-md-1">
                            <form action="{{ action('SimpleController@store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="mt-csv-export"
                                            id="mt-csv-export">
                                        <label class="custom-file-label" for="mt-csv-export" data-browse="Böngészés">Fájl
                                            kiválasztása</label>
                                    </div>
                                </div>
