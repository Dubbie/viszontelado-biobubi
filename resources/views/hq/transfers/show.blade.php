                ...
                <div class="card card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="font-weight-bold text-muted mb-4 mb-md-0" style="line-height: 1.25">Az átutalásról szóló fontos információk.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8 offset-md-1">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-4">
                                    <p class="font-weight-semibold text-muted mb-0">Létrehozva</p>
                                </div>
                                <div class="col-md-8">
                                    <p class="mb-0">{{ $transfer->created_at->format('Y.m.d H:i:s') }}</p>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-4">
                                    <p class="font-weight-semibold text-muted mb-0">Állapot</p>
                                </div>
                                <div class="col-md-8">
                                    <p class="{{ $transfer->getTextColorClass() }} font-weight-semibold mb-0">
                            ...
                            @if($transfer->isCompleted())
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <p class="font-weight-semibold text-muted mb-0">Könyvelve</p>
                                    </div>
                                    <div class="col-md-8">
                                        <p class="mb-0">{{ $transfer->completed_at->format('Y.m.d H:i:s') }}</p>
                                    </div>
                                </div>
                            @endif
                        </div>
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-8 offset-md-1">
                            ...
                            @else
                                <hr>
                                <p class="font-weight-normal lead mb-1">A viszonteladó számlázási adatai nincsenek kitöltve.</p>
                                <p class="mb-0">
                                    <a href="{{ action('UserController@edit', $transfer->reseller) }}" class="btn btn-sm btn-teal font-weight-semibold align-items-center d-inline-flex">
                        ...
                        <div class="col-md-8 offset-md-4">
                            @if(!$transfer->isCompleted())
                                <button type="button" data-toggle="modal" data-target="#completeTransfer"
                                        class="btn btn-sm btn-outline-success">Teljesítés
                                </button>
                            @else
                                <div class="d-flex">
                                    <a href="{{ action('MoneyTransferController@downloadAttachment', $transfer) }}" class="btn btn-sm btn-primary mr-1">Csatolmány letöltése</a>
                                    <form id="form-delete-transfer" action="{{ action('MoneyTransferController@destroy', $transfer) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-link text-muted">Átutalás törlése</button>
                                    </form>
                                </div>
                            @endif
                        </div>
