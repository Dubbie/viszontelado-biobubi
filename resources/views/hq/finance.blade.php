    ...
    <div id="hq-finance-page" class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-auto text-md-right">
                {{--<a href="{{ action('OrderController@updateOrderIncomes') }}" class="btn btn-primary">Bevételek
                    frissítése</a>--}}
                <a href="{{ action('ReportController@regenerateReports') }}" class="btn btn-success">Riportok
                    újragenerálása</a>
                <a href="#newMarketingResult" data-toggle="modal" class="btn btn-outline-primary">Új marketinges
                    riport</a>
            </div>
        </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <button type="button" class="btn btn-sm p-0 btn-outline-secondary"
                                        ...
                                        <span class="icon">
                                            <svg width="16px" height="16px" viewBox="0 0 16 16" class="bi bi-plus"
                                                 fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <span class="has-tooltip" data-toggle="tooltip"
                                          title="Új központi kiadás hozzáadása">
                                        <button type="button" class="btn btn-sm p-0 btn-outline-secondary"
