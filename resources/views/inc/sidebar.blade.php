<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item">
                <a href="#customers-collapse"
                    class="nav-link position-relative @if (!Request::is('ugyfelek*') && !Request::is('hivandok*')) collapsed @endif"
                    data-toggle="collapse">
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                    ...
                    @if (Auth::user()->calls()->count() > 0)
                        <span class="bi bi-icon text-success position-absolute" style="right: 40px">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                fill="currentColor" class="bi bi-record-fill" viewBox="0 0 16 16">
                ...
                <div id="customers-collapse" class="collapse @if (Request::is('ugyfelek*') || Request::is('hivandok*')) show @endif">
                    ...
                    <a class="nav-link @if (Request::is('hivandok*')) active @endif"
                        ...
                        <span>Hívandók <span
                                class="badge badge-pill badge-success">{{ Auth::user()->calls()->count() }}</span></span>
                    </a>
                </div>
            </li>
            ...
            @if (Auth::user()->worksheet()->count() > 0)
                <li class="nav-item">
                    <a href="#worksheetModal" data-toggle="modal"
                        class="nav-link @if (Request::is('keszletem*')) active @endif d-flex align-items-center">
                        <span class="icon">
            ...
            @if (Auth::check() && Auth::user()->admin)
                ...
                <li>
                    <a href="{{ action('RegionController@index') }}"
                        class="nav-link @if (Request::is('regiok*') && !Request::is('regiok/biobubi-futar')) active @endif">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                ...
                <li>
                    <a href="{{ action('RegionController@biobubiDeliveries') }}"
                        class="nav-link @if (Request::is('regiok/biobubi-futar')) active @endif">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
