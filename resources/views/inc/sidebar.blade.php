<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item">
                <a href="#customers-collapse" class="nav-link @if(!Request::is('riport*')) collapsed @endif"
                   data-toggle="collapse">
                    <span class="icon">
                    ...
                    </span><span>Ügyfelek</span>
                </a>

                <div id="customers-collapse" class="collapse @if(Request::is('ugyfelek*')) show @endif">
