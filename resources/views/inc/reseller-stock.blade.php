...
<p class="text-muted mb-4">A viszonteladó készlet nyilvántartása. A <b>Foglalt</b> termékek, azok amikre érkezett
    megrendelés és még <b>Függőben lévő</b> a státusza.</p>
@if($user->stock()->count() > 0)
    ...
    <table class="table table-sm table-borderless table-striped mb-0">
        ...
        <tr>
            ...
            <th class="text-right">
                <small class="font-weight-bold">Raktár</small>
            </th>
            <th class="text-right">
                <small class="font-weight-bold">Foglalt</small>
            </th>
            <th class="text-right">
                <small class="font-weight-bold">Kiszállítva</small>
            </th>
        </tr>
        </thead>
        <tbody>
    ...
    <p class="mt-4 mb-0">
        ...
        <a href="{{ action('StockController@edit', $user) }}" class="btn btn-link text-muted btn-sm">Viszonteladó
            készletének szerkesztése</a>
    </p>
@else
